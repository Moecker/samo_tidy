...
import samo_tidy.checker.samo_class_file_name_checker.samo_class_file_name_checker as the_checker
...
class TestSamoClassFileNameChecker(test_checker_lib.TestCheckerLib):
    ...
    def test_validate_translation_unit_based(self):
        filename = os.path.join(self.checker_test_files, "samo_class_file_name_checker.cpp")
