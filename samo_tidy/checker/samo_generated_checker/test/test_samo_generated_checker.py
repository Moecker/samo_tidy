...
import samo_tidy.checker.samo_generated_checker.samo_generated_checker as the_checker
import samo_tidy.checker.test.test_checker_lib as test_checker_lib
import samo_tidy.test.test_support as test_support


class TestSamoGeneratedChecker(test_checker_lib.TestCheckerLib):
    def setUp(self):
        super().setUp()
        self.checker_test_files = os.path.join(os.path.dirname(__file__), "data")

    def test_validate_token_based(self):
        filename = os.path.join(self.checker_test_files, "samo_generated_checker.cpp")
